...
__author__ = "whatnick"
__Comment__ = 'model description for JST-SH Connectors using cadquery. Datasheet: http://www.jst-mfg.com/product/pdf/eng/eSH.pdf'

___ver___ = "1.0 09/03/2020"
class LICENCE_Info():
    ############################################################################
    STR_licAuthor = "Tisham Dhar"
    STR_licEmail = "whatnickd@gmail.com"
    STR_licOrgSys = ""
    STR_licPreProc = ""
