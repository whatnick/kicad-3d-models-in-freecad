...
__author__ = "whatnick"
__Comment__ = 'model description for JST-PH Connectors using cadquery. Datasheet: http://www.jst-mfg.com/product/pdf/eng/eSH.pdf'

___ver___ = "1.0 09/03/2020"
...
class series_params():
    ...
    variant_params = {
        'top_entry':{
            'mpn_format_string': 'B{pincount}B-SH-K',
            'orientation': 'V',
        ...
        'side_entry':{
            'mpn_format_string': 'S{pincount}B-SH-K',
            'orientation': 'H',
            'datasheet': 'http://www.jst-mfg.com/product/pdf/eng/eSH.pdf',
